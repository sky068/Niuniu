 ...
 * @constructor
 */
PokerUtils.TypeReturn = function (type, mCard, ncards, pcards) {
 ...
 * @return {Array}
 */
PokerUtils.create1pairPoker = function(isShuffle) {
    var cards = [];
    ...
    isShuffle = isShuffle == undefined?true:isShuffle;

    if (isShuffle) {
        cards = PokerUtils.shuffle(cards);
    }
 ...
 * @return {*}
 */
PokerUtils.shuffle = function(arr) {
    var i, j, temp;
 ...
 */
PokerUtils.sortBig2Samll = function(cardsArr) {
 ...
 */
PokerUtils.compareHandsReturn = function(typeReturn1, typeReturn2) {
